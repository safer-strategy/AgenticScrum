...
curl -fsSL https://raw.githubusercontent.com/Anthropic/AgenticScrum/main/scripts/quick-init-update.sh | bash

# Add security training features
curl -fsSL https://raw.githubusercontent.com/Anthropic/AgenticScrum/main/scripts/quick-security-update.sh | bash

# Add animated ASCII banner
curl -fsSL https://raw.githubusercontent.com/Anthropic/AgenticScrum/main/scripts/quick-banner-update.sh | bash

# Install standalone patcher globally
curl -fsSL https://raw.githubusercontent.com/Anthropic/AgenticScrum/main/scripts/quick-install-patcher.sh | bash
```
...
curl -fsSL https://raw.githubusercontent.com/Anthropic/AgenticScrum/main/download-patch-updates.sh -o patch-updater.sh
